...
public class ArbolExpresionGrafico extends JPanel 
{
     ...
     * dibujar.
     */
    public ArbolExpresionGrafico(ArbolBinario ArbolBinario) 
    {
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         Nodo root = this.ArbolBinario.getRaiz();
         if (root != null) 
         {
   ...
   public void paint(Graphics g) 
   {
         ...
         dibujarArbol(g2d, this.ArbolBinario.getRaiz(), Integer.MAX_VALUE, Integer.MAX_VALUE, 
